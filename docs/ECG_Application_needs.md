...
| Subindikatoren angeben. Benutzer können auf der Indikator- die jeweiligen Subindikatoren angeben. Dazu stehen zusätzlich zum Indikator pro Subindikator Editor und Slider mit Speicherfunktion zur Verfügung. Berechtigungen können nur für den übergeordneten Indikator gesetzt werden. | 400,00 € |
...
| Feedback am Matrix-Entwicklungsteam senden. Eine Form mit Eingabetext, Captcha und Senden-Button auf die Indikator-Seite. | 150,00€ |
...
| Kommentare zum Indikator abgeben. Benutzer können auf der Indikator- Kommentare erstellen und auf vorhandene Kommentare antworten. Zu ihrem Kommentar werden jeweils Name, Datum und Profilbild angezeigt. | 300,00 € |
...
| Bilder zum Indikator hochladen. Benutzer können auf der Indikator- über den Editor Bilder vom eigenen Rechner hochladen und einfügen. Diese Funktion steht auch für Subindikatoren zur Verfügung. | 100,00€ |
