    ...
    data : {
        indicators : [
            /* ----------------------------------- C1 ----------------------------------- */
            {
                ...
                goals : {
                    content:
                    '<p>Von den Grundrechten ist kein Lebensbereich ausgenommen. Die in ihnen festgeschriebenen Werte der Unantastbarkeit der Menschenwürde, das Recht auf Unversehrtheit, Freiheit und freie Entfaltung der persönlichkeit sowie auf Gleichberechtigung gelten somit uneingeschränkt auch für das Arbeitsleben.</p>'+
                        '<p>Am Arbeitsplatz (im Arbeitsverhältnis) zeigt sich Menschenwürde durch die Gleichwertigkeit und Chancengleichheit aller im Unternehmen arbeitenden personen und dem Ziel möglichst gesunder, freier und kooperativer Arbeitsbedingungen. Das Gegenteil sind Aus-beutung zugunsten des Gewinns Einzelner, Verweigerung von Mitbestimmung, Diskrimi-nierung oder Schädigung der Gesundheit.</p>'+
